...
namespace StockMarketSolution.ViewComponents
{
    public class SelectedStockViewComponent : ViewComponent
 {
  ...
  private readonly IStockBuyOrderService _stocksService;
  private readonly IFinhubCompanyProfileService _finnhubCompanyProfileService;
  private readonly IFinhubStockPriceQouteService _finnhubStockPriceQuoteService;
  ...
  public SelectedStockViewComponent(IOptions<TradingOptions> tradingOptions, IStockBuyOrderService stocksService, IFinhubCompanyProfileService finnhubCompanyProfileService, IFinhubStockPriceQouteService finnhubStockPriceQuoteService, IConfiguration configuration)
  {
